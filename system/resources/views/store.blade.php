        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="product-details">
              <h2 class="product-name">Summer Jacket</h2>
              <div>
              ...
              <div>
                <h3 class="product-price">Rp 100.000  <del class="product-old-price">Rp 150.000</del></h3>
                <span class="product-available">In Stock</span>
              </div>
              <p>Buy the latest quality Online Summer Jackets at the latest low prices 2020 at Young Tian Shop Easy payment, fast delivery</p>
          ...
          <div class="col-md-12">
            <div id="product-tab">
              ...
              <div class="tab-content">
                <!-- tab1  -->
                <div id="tab1" class="tab-pane fade in active text-center">
                  <div class="row">
                    <div class="col-md-12">
                      <p>This summer jacket is specially designed to accompany your summer. These summer jackets are made of the highest quality. This jacket is also water resistant and does not fade easily. Besides, the attractive color looks more aesthetic.</p>
                    </div>
                  </div>
                </div>
                <!-- /tab1  -->
                ...
                <div id="tab2" class="tab-pane fade in text-center">
                  <div class="row">
                    <div class="col-md-12">
                      <p>Made of the highest quality, Does not heat up easily, Neat stitch details, The material is waterproof, Does not wear off easily, Attractive colors.</p>
                    </div>
                  </div>
                </div>
                <!-- /tab2  -->
                        ...
                        <ul class="reviews">
                          <li>
                            <div class="review-heading">
                              <h5 class="name">Meti Lamitasari</h5>
                            ...
                            <div class="review-body">
                              <p>I like the material is very good, Thank you Young Tian Shop</p>
                            </div>
                          </li>
                          <li>
                            <div class="review-heading">
                              <h5 class="name">Erpi Resti Utari</h5>
                              <p class="date">27 DEC 2018, 8:0 PM</p>
                              <div class="review-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                            ...
                            <div class="review-body">
                              <p>The material is pretty good, I give it 4 stars</p>
                            </div>
                          </li>
                          <li>
                            <div class="review-heading">
                              <h5 class="name">Elisabet Enisriwasi</h5>
                              <p class="date">27 DEC 2018, 8:0 PM</p>
                              <div class="review-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                            ...
                            <div class="review-body">
                              <p>The goods are quickly delivered with good quality I like</p>
                            </div>
                          </li>
                        </ul>
